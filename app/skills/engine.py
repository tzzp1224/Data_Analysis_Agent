...
def execute_skill(
    ...
    if skill_name == "l3_reconcile":
        return run_l3_reconcile_skill(dfs_context, instruction)
    if skill_name == "l1_hygiene":
        return run_l1_hygiene_skill(dfs_context, user_instruction=instruction)
    if skill_name == "l1_l2_hygiene_merge":
        return run_l1_l2_hygiene_merge_skill(dfs_context, user_instruction=instruction)
    return None
